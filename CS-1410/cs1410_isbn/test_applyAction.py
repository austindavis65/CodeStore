...
class TestApplyAction( unittest.TestCase ):
    ...
    def setUp(self):
        ...
        self.recordBookAction = isbn_index.recordBookAction
        self.findBookAction = isbn_index.findBookAction
        self.listBooksAction = isbn_index.listBooksAction
        self.quitAction = isbn_index.quitAction
    ...
    def tearDown(self):
        isbn_index.recordBookAction = self.recordBookAction
        isbn_index.findBookAction = self.findBookAction
        isbn_index.listBooksAction = self.listBooksAction
        isbn_index.quitAction = self.quitAction
        return
